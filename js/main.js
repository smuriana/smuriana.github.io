...
const translations = {
    en: {
        ...
        'exp.phoenixnap.desc': 'Platform-focused software engineer responsible for operating and evolving core production infrastructure. Led the migration from nginx Ingress to Envoy Gateway, and championing the adoption of OpenTelemetry for distributed tracing and observability. Also working on authentication platforms (Keycloak), CI/CD infrastructure, and Kubernetes-based workloads.',
    ...
    es: {
        ...
        'exp.phoenixnap.desc': 'Ingeniero de software enfocado en plataforma, responsable de operar y evolucionar la infraestructura de producción principal. Lideré la migración de nginx Ingress a Envoy Gateway, y soy el impulsor de la adopción de OpenTelemetry para trazado distribuido y observabilidad. También trabajo en plataformas de autenticación (Keycloak), infraestructura CI/CD y cargas de trabajo en Kubernetes.',
